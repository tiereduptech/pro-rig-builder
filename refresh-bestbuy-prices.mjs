...
const priceMovement = movementFor({
  parts, retailer: 'bestbuy', today,
  // Not gated on `breakers` — a tripped breaker blocks removals, not stamps,
  // so it must not block the epoch that dates them. See movementFor.
  wroteStamps: APPLY,
